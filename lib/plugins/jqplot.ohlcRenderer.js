...
//following else if block adds error bar functionality as per this post
// https://bitbucket.org/cleonello/jqplot/issue/35/add-error-bar-capability#comment-141580
                else if (r.errorBar) {
